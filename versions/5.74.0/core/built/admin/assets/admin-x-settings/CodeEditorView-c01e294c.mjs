import { a as ke, b as N, bP as Rt, bQ as qn, e as wt, bR as _n, j as F, bS as Hn, u as Vn, R as zn, q as Un, d as $n, H as Gn, c as Kn } from "./index-6594c4bf.mjs";
import { E as p, F as fe, v as Ee, S as Re, o as d, w as qe, C as Jn, x as jn, y as Tt, z as Ot, A as Se, B as It, G as Pt, H as Wt, J as Ue, K as Xe, M as w, O as Z, g as et, b as $e, Q as Qn, R as ee, V as Ft, U as x, W as Yn, X as Zn, Y as ce, Z as M, _ as Xn, $ as er, a0 as tt, a1 as ue, a2 as tr, a3 as nr, a4 as rr, a5 as or, a6 as ir, a7 as sr, a8 as lr, a9 as ar, aa as cr, ab as ur, ac as hr, ad as fr, ae as dr, af as mr, ag as Nt, ah as gr, ai as pr, aj as yr, ak as xr, al as kr, am as br, an as qt, ao as Sr, ap as Cr, t as f, aq as vr } from "./index-9cc1df42.mjs";
const Ar = (t) => {
...
const Ge = /* @__PURE__ */ Xe.define(), wr = /* @__PURE__ */ Xe.define(), Tr = /* @__PURE__ */ fe.define(), Ht = /* @__PURE__ */ fe.define({
  combine(t) {
    return Ee(t, {
      minDepth: 100,
      newGroupDelay: 500,
...
const ht = (t) => cn(t, !1), ft = (t) => cn(t, !0), lo = (t) => B(t, (e) => _(t, e, !0)), ao = (t) => B(t, (e) => _(t, e, !1)), co = (t) => B(t, (e) => _(t, e, !b(t))), uo = (t) => B(t, (e) => _(t, e, b(t))), ho = (t) => B(t, (e) => d.cursor(t.lineBlockAt(e.head).from)), fo = (t) => B(t, (e) => d.cursor(t.lineBlockAt(e.head).to)), dt = ({ state: t, dispatch: e }) => (e(I(t, { anchor: 0 })), !0), mt = ({ state: t, dispatch: e }) => (e(I(t, { anchor: t.doc.length })), !0), gt = ({ state: t, dispatch: e }) => (e(I(t, { anchor: t.selection.main.anchor, head: 0 })), !0), pt = ({ state: t, dispatch: e }) => (e(I(t, { anchor: t.selection.main.anchor, head: t.doc.length })), !0), mo = ({ state: t, dispatch: e }) => (e(t.update({ selection: { anchor: 0, head: t.doc.length }, userEvent: "select" })), !0), go = ({ state: t, dispatch: e }) => {
...
const he = /* @__PURE__ */ w.define(), st = /* @__PURE__ */ w.define(), q = /* @__PURE__ */ Re.define({
  ...
  update(t, e) {
    for (let r of e.effects)
      r.is(he) ? t = new Ve(r.value.create(), t.panel) : r.is(st) && (t = new Ve(t.query, r.value ? lt : null));
    return t;
  },
...
const Ni = [
  ...
  const S = Vn(), D = wt(null), [$, G] = ke(100), [H, K] = zn.useState(null), { setFocusState: V } = Un(), ie = (E) => {
    c == null || c(E), V(!0);
  }, z = (E) => {
    u == null || u(E), V(!1);
  };
...
//# sourceMappingURL=CodeEditorView-c01e294c.mjs.map
